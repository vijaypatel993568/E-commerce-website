            ...
            <div className="col-lg-4 col-md-6">
              <div className="ftco-footer-widget mb-4">
                ...
                <div className="block-23 mb-3">
                  <ul>
                    <li><span className="icon icon-map-marker"></span><span className="text">sector-12,201301,Noida,UP, India</span></li>
                    <li><Link to="#"><span className="icon icon-phone"></span><span className="text">+919935684372</span></Link></li>
                    <li><Link to="#"><span className="icon icon-envelope"></span><span className="text"> vijaypatel993568@gmail.com</span></Link></li>
                  </ul>
