	      ...
	      <div className="slider-item js-fullheight">
	        ...
	        <div className="container-fluid p-0">
	          <div className="row d-flex no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
				...
				<div id="carouselExampleControls" className="carousel slide sliderbackgrond " data-ride="carousel">
							...
							<div className="row no-gutters choose-wrap divider-two align-items-stretch">
								...
								<div className="col-md-12">
									<div className="row no-gutters">
										...
										<div className="col-md-6">
											<div className="choose-wrap wrap img align-self-stretch d-flex align-items-center" style={{ backgroundImage: "url('assets/images/pr-26.jpg')" }}>
